<template>
    <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" @submit.prevent="contentupdate" enctype="multipart/form-data" method="post">
...
export default {
   name:'asdfasdfsd',
    ...
    mounted() {
        ...
        this.$store.dispatch("getsubCategoryFormGetters")

      },
     created(){

      axios.get('/subcategoryList').then((response) =>{
        this.subcategory=response.data.subcategories;
      
       })
       axios.get('/edit_content/'+this.$route.params.contentid).then((response) =>{
        // this.form.fill(response.data.subcategory_id)
       
        this.category_id=response.data.editcontent.category_id;
        this.subcategory_id=response.data.editcontent.subcategory_id;
        this.title=response.data.editcontent.title;
        this.description=response.data.editcontent.description;
        this.video_url=response.data.editcontent.video_url;
       })
    },
      computed: {
        ...
        // subcategory(){ //final output from here
...
// this.form.post(`/update_subcategory/${this.$route.params.subcategoryid}`)
